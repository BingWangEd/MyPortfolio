...
class ExperienceButton extends Component {
  render(){
    if (this.props.selectedExperienceCategory.length===this.props.categories.length) {
      ...
      return (<div><img onClick={(e)=>this.props.selectAllExperienceCategories(this.props.categories)} src = {process.env.PUBLIC_URL+ 'icons/unchecked_checkbox.png'} alt='unchecked_checkbox'/>My Professional Experiences</div>)
    }
  }
}
